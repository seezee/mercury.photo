...
<svg hidden xmlns="http://www.w3.org/2000/svg" id="icon-sprite">
  <defs>
    ...
    <symbol id="icon-sitemap-duo" viewBox="0 0 640 512">
      <path fill="var(--mpb-color-accent-reverse)" d="M104 320H56v-57.59A38.45 38.45 0 0 1 94.41 224H296v-64h48v64h201.59A38.46 38.46 0 0 1 584 262.41V320h-48v-48H344v48h-48v-48H104z"/>
...
{% image "featured", "img-constrained", "1892 map of the Indian Territory (Oklahoma).", "1892 map of the Indian Territory (Oklahoma), Library of Congress", "eager" %}</mpb-dialog-img>
