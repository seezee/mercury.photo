...
Today we present candid images from my first year as a volunteer photographer for the <span class="h-card p-organization"><span class="p-name"><span class="p-nickname">Woody</span> Guthrie</span> Folk Festival</span>.<a href="#mn:1" id="mnref:1"><span class="sr-only"> [See note]</span></a> I was still learning to use my newly-acquired <a href="https://amzn.to/39nqnre" target="_blank" rel="external noopener">Leica digital rangefinder camera</a> when I shot the <time datetime="2012-07">2012</time> festival from the audience.  A <time datetime="2013-07">year later</time> I had shot numerous musical performances and festivals, so I was feeling much more confident as I documented the <time datetime="2013-07">2013</time> Woodyfest.
