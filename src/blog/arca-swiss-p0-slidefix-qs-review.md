...
{% image "featured", "img-constrained", "A carbon fibre tripod folded and lying on a hooked rug. The tripod is topped with an Arca-Swiss P0 Tripod Head", "Gitzo GT1542T Series 1 Traveler w/ Arca-Swiss P0 Monoball Fix", "eager" %}</mpb-dialog-img>
