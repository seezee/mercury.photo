...
[^2]: <span class="h-card p-org">Black Sabbath</span>’s first song, <cite class="short-work">A Song for Jim</cite> was <q>an absolute Charlie Christian takeoff.</q>&NoBreak;&hairsp;&NoBreak;&mdash;&NoBreak;&hairsp;&NoBreak;<cite class="h-card p-name cite-person">Jim Simpson</cite>, quoted in <cite class="h-card p-name cite-person">Martin Popoff</cite>’s <cite>Black Sabbath FAQ</cite> (Backbeat Books, <time datetime="2011">2011</time>).

Western swing got its start at Tulsa’s <span class="h-card p-org">Cain’s Ballroom</span>, where couples danced to <span class="h-card p-org"><span class="h-card p-name">Bob Wills</span> and His Texas Playboys</span>. A few decades later <span class="h-card p-name">Leon Russell</span> converted a church into a studio; soon after, Russell and his Tulsa Mob gave rock ’n’ roll radio stations around the world the “Tulsa Sound”&NoBreak;&hairsp;&NoBreak;&mdash;&NoBreak;&hairsp;&NoBreak;influencing musicians as far away as British rockers <span class="h-card p-name">Eric Clapton</span> and <span class="h-card p-name">Mark Knopfler</span>. Clapton played various Tulsa venues so often in the <time datetime="1978">1970s</time>[^3] that critic <span class="h-card p-name">Robert Christgau</span> wrote <q>Whatever Eric isn’t anymore&nbsp;&hellip; he’s certainly king of the Tulsa sound.</q>[^4]
