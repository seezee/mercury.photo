...
Festival regular <span class="h-card p-name">Chris Buhalis</span> provided musical examples for Wolff’s lecture. <cite>Grown Up Anger</cite> was published by <span class="h-card p-org">Harper</span> in <time datetime="2017">2017</time> and is available from all of the usual sources.
