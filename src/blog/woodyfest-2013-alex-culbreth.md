...
In a recent podcast [interview](https://web.archive.org/web/20140227154417/http://www.americanamusicshow.com/alex-culbreth-and-the-dead-country-stars/){target=_blank rel="external noopener"}, Culbreth stated that he drew songwriting inspiration from <span class="h-card p-name">[Tom Waits](https://music.apple.com/us/artist/tom-waits/id83964?uo=4&at=10ldhk){target=_blank rel="external noopener"}</span> and <span class="h-card p-name">[Townes Van Zandt](https://music.apple.com/us/artist/townes-van-zandt/id657309?uo=4&at=10ldhk){target=_blank rel="external noopener"}</span> . His new album with the <span class="h-card p-org">Dead Country Stars</span>, <cite>Heart in a Mason Jar</cite>, recently reached the number 10 spot in the Euro Americana chart, receiving many favorable reviews.
